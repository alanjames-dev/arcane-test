...
<section class="team-section text-center my-5">
  ...
  <!-- Section description -->
  <p class="grey-text w-responsive mx-auto mb-5">Arcane Society is a CTF team and peer to peer community that focuses on cyber security enthusiasts. A CTF is basically a cyber war game where we have to solv <br><br> We are just a bunch of people who  <br><br> Join us and let's have fun and play CTFs. We give you the freedom to do your best work, on your own terms.</p><br>
  ...
  <div class="row">
    ...
    <div class="col-lg-3 col-md-6 mb-lg-0 mb-5">
      <div class="avatar mx-auto">
        <img src="img\profiles\ananthu250.jpeg" class="z-depth-1" style="border-radius: 10px"
          alt="ananthu">
      </div>
      <h5 class="font-weight-bold mt-4 mb-3">Ananthu Anil</h5>
    ...
    <div class="col-lg-3 col-md-6 mb-lg-0 mb-5">
      <div class="avatar mx-auto">
        <img src="img\profiles\arjun250.jpg" class="z-depth-1" style="border-radius: 10px"
          alt="arjun">
      </div>
      <h5 class="font-weight-bold mt-4 mb-3">Arjun R</h5>
      <p class="text-uppercase blue-text"><strong>Co-founder</strong></p>
      <ul class="list-unstyled mb-0">
        <!--Email-->
      <a type="button" class="btn-floating btn-sm mx-1 mb-0 btn-email">
    ...
    <div class="col-lg-3 col-md-6 mb-lg-0 mb-5">
      <div class="avatar mx-auto">
        <img src="img\profiles\aliya250.jpg" class="z-depth-1" style="border-radius: 10px"
          alt="Sample avatar">
      </div>
      <h5 class="font-weight-bold mt-4 mb-3">Aliya Ashraf</h5>
      <p class="text-uppercase blue-text"><strong>Co-founder</strong></p>
      <ul class="list-unstyled mb-0">
        <!--Email-->
      <a type="button" class="btn-floating btn-sm mx-1 mb-0 btn-email">
    ...
    <div class="col-lg-3 col-md-6 mb-lg-0 mb-5">
      <div class="avatar mx-auto">
        <img src="img\profiles\avinash250.jpg" class="z-depth-1" style="border-radius: 10px"
          alt="Sample avatar">
      </div>
      <h5 class="font-weight-bold mt-4 mb-3">Avinash Thomas</h5> 
      <p class="text-uppercase blue-text"><strong>Co-founder</strong></p>
      <ul class="list-unstyled mb-0">
        <!--Email-->
      <a type="button" class="btn-floating btn-sm mx-1 mb-0 btn-email">
...
<!-- Section: Team v.2 -->
<section class="team-section text-center my-5">
<h3 class="h1-responsive font-weight-bold my-5">Co-ordinator Team</h3><br>
  <!-- Grid row -->
  <div class="row">
    ...
    <div class="col-lg-3 col-md-6 mb-lg-0 mb-5">
      ...
      <!--    alt="Sample avatar">-->
      <!--</div>-->
      <h5 class="font-weight-bold mt-4 mb-3"><strong>Web Team</strong></h5>
      <p class="grey-text">Allen V Tom<br>Asif Shereef<br>Dana Rose<br>Donika Bose<br>Meera M Nair</p>
    </div>
    <!-- Grid column -->

    <!-- Grid column -->
    <div class="col-lg-3 col-md-6 mb-lg-0 mb-5">
      <h5 class="font-weight-bold mt-4 mb-3"><strong>Design Team</strong></h5>
      <p class="grey-text">Annu Mary Abraham<br>Elizabeth Stephen<br>Jesna Susan Reji<br>Kripa Susan Shaji</p>
    </div>
    <!-- Grid column -->

    <!-- Grid column -->
    <div class="col-lg-3 col-md-6 mb-lg-0 mb-5">
      <h5 class="font-weight-bold mt-4 mb-3"><strong>Challenge Team</strong></h5>
      <p class="grey-text">Jonat J Mathew<br>Reejo Kuriakose<br>Sharon K J</p>
    </div>
    <!-- Grid column -->

    <!-- Grid column -->
    <div class="col-lg-3 col-md-6 mb-lg-0 mb-5">
      <h5 class="font-weight-bold mt-4 mb-3"><strong>WriteUp Team</strong></h5>
      <p class="grey-text">Diona Joseph<br>Sam Stephen Thomas<br>Vimal Sajan George</p>
    </div>
    <!-- Grid column -->
