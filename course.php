...
<body class="imgloaded">
    ...
    <div class="jumbotron bg-transparent mb-0 pt-3 radius-0">
        <div class="container">
            <div class="row">
                <div class="col-xl-12">
                    <h1 class="display-1 bold color_white content__title text-center"><span class="color_danger">COU</span>RSE<span class="vim-caret">&nbsp;</span></h1>
                            <div class="row text-center pt-5">
                                <div class="col-xl-12">
                                        <h4 class="display-1 bold color_white content__title text-center">COMING SOON!</h4>
